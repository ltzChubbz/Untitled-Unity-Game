...
public class SimpleAES
{
    ...
    private const string initVector = "wte684dhimp5a4jk";
...
public class SaveSystem : MonoBehaviour
{
    ...
    protected static string encryptKey = "8d9gkiq0pvmbbyttjkdiovpq";
    protected static string savePath = "/idlegame.save";
    protected static string savePathBackUP = "/idlegamebackup.save";
    ...
    public void ImportPlayer2(IdleTutorialScript playerData)
    {
